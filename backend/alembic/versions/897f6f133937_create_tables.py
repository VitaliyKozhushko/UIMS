...
def upgrade() -> None:
    ...
    sa.Column('gender', sa.Enum('male', 'female', 'other', 'unknown', name='gender_name'), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('proposed', 'pending', 'booked', 'arrived', 'fulfilled', 'cancelled', 'noshow', 'entered-in-error', 'checked-in', 'waitlist', name='status_enum'), nullable=False),
